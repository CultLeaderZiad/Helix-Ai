...
const INITIAL_PREFERENCE_MODULES: PreferenceModule[] = [
  ...
  },
  {
    ...
    description: 'Gentle conversational reminders with instant Stripe/Tabby settlement links',
    system: 'outbound',
...
export function StudioAgentIde({
  ...
  return (
    <div className="mx-auto w-full max-w-[1440px] select-none text-slate-200">
      {/* Top Main Window Chrome (Matching Image 1) */}
      <div className="overflow-hidden rounded-2xl border border-slate-800/90 bg-[#0c1017] shadow-[0_24px_64px_-12px_rgba(0,0,0,0.85)]">
        {/* Window Top Titlebar */}
        <div className="flex h-11 items-center justify-between border-b border-slate-800/80 bg-[#090d14] px-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 text-xs">
              <span className="font-semibold text-white">Helix Studio</span>
              <span className="text-slate-500">/</span>
              <span className="rounded-md bg-slate-800/70 px-2 py-0.5 font-mono text-[11px] text-cyan-400">
                {brandName.toLowerCase().replace(/\s+/g, '-')}
              </span>
              <span className="flex items-center gap-1 rounded-md border border-slate-700/60 bg-slate-800/40 px-2 py-0.5 text-[11px] text-slate-300">
          ...
          <div className="flex items-center gap-1 rounded-xl border border-slate-800 bg-[#0c1322] p-1">
            <button
              type="button"
              onClick={() => {
              ...
              className={cn(
                ...
                systemLayer === 'inbound'
                  ? 'bg-cyan-500/20 text-cyan-300 shadow-[0_0_12px_rgba(0,210,255,0.25)] border border-cyan-500/30'
          ...
          <div className="flex items-center gap-2.5">
            <div className="flex items-center gap-1.5 rounded-lg border border-slate-800 bg-slate-900/80 px-2.5 py-1 text-[11px]">
              <span className="size-1.5 rounded-full bg-emerald-400 animate-ping" />
              <span className="font-mono font-medium text-slate-300">38ms LPU</span>
            </div>
            <button
              type="button"
              onClick={handleRequestBuild}
              disabled={isPending}
              className="flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 px-3 py-1 text-xs font-bold text-slate-950 shadow-[0_0_16px_rgba(0,210,255,0.35)] hover:from-cyan-400 hover:to-blue-500 transition-all active:scale-95"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[260px_minmax(0,1fr)_300px] min-h-[760px] border-b border-slate-800/80">
          
          {/* ========================================================================= */}
          {/* LEFT SIDEBAR: Tasks, Projects & Agent Architecture Tree (Image 1 Left) */}
          {/* ========================================================================= */}
          <aside className="flex flex-col border-r border-slate-800/80 bg-[#090d15] p-3">
            ...
            <div className="space-y-1 pb-3 border-b border-slate-800/80">
              <button
                ...
                className="flex w-full items-center justify-between rounded-xl bg-slate-800/60 px-3 py-2 text-xs font-semibold text-slate-200 hover:bg-slate-800 hover:text-white transition-all"
              >
              ...
              <div className="grid grid-cols-2 gap-1 pt-1">
                <button
                  type="button"
                  className="flex items-center gap-1.5 rounded-lg border border-slate-800 bg-slate-900/40 px-2.5 py-1.5 text-[11px] font-medium text-slate-400 hover:text-white transition-colors"
                >
            ...
            <div className="flex-1 overflow-y-auto py-3 space-y-4 scrollbar-thin">
              ...
              <div>
                <div className="flex items-center justify-between px-2 text-[10px] font-mono uppercase tracking-wider text-slate-500 font-bold">
            ...
            <div className="pt-3 border-t border-slate-800/80 flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                <div className="relative flex size-8 items-center justify-center rounded-full bg-gradient-to-tr from-cyan-500 to-purple-600 text-[11px] font-black text-slate-950 shadow-[0_0_12px_rgba(0,210,255,0.4)]">
                  HA
                  <span className="absolute bottom-0 right-0 size-2 rounded-full bg-emerald-400 ring-2 ring-[#090d15]" />
                </div>
                <div className="flex flex-col">
                  <span className="text-xs font-semibold text-white">Helix Agent Bot</span>
                  <span className="text-[10px] font-mono text-cyan-400">Autonomous v4.2</span>
                </div>
              </div>
              <button
                type="button"
          ...
          <main className="flex flex-col bg-[#0b0f17] overflow-hidden">
            ...
            <div className="flex items-center justify-between border-b border-slate-800/80 bg-[#0c121e] px-4 py-2">
              <div className="flex items-center gap-2 overflow-x-auto scrollbar-none">
                ...
                >
                  ...
                  <span className="rounded bg-cyan-500/30 px-1 py-0.2 text-[9px] font-bold text-cyan-200">
                    LIVE
                  </span>
                </button>
            ...
            <div className="relative flex-1 overflow-y-auto p-4 lg:p-6 scrollbar-thin">
                ...
                {isCompiling3D && (
                  ...
                  >
                    <div className="relative flex size-20 items-center justify-center">
                      ...
                      />
                      <Cpu className="size-8 text-cyan-300 animate-pulse" />
                    </div>
              ...
              {activeIdeTab === 'site_demo' && (
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2 rounded-xl border border-slate-800 bg-[#090e18] p-2.5">
                    <div className="flex items-center gap-2">
                  ...
                  {showConversionHud && (
                    <motion.div
                      ...
                      className="rounded-xl border border-cyan-500/30 bg-gradient-to-r from-cyan-950/40 via-slate-900/60 to-purple-950/40 p-3 shadow-lg"
                    >
                      <div className="flex flex-wrap items-center justify-between gap-3 text-xs">
                        <div className="flex items-center gap-2">
                          <span className="flex size-6 items-center justify-center rounded-lg bg-cyan-500/20 text-cyan-300 font-bold">
                            1
                          </span>
                          <div>
                            <div className="text-[10px] uppercase font-mono text-slate-400">Traffic Ingest</div>
                            <div className="font-semibold text-white">Visitor Lands on Site</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <div className="text-[10px] uppercase font-mono text-slate-400">Calendar Sync</div>
                            <div className="font-semibold text-white">2-Way Cal.com Confirmed</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <div className="text-[10px] uppercase font-mono text-slate-400">CRM Deal Booked</div>
                  ...
                  <div className="relative overflow-hidden rounded-2xl border border-slate-800 bg-[#070b12] p-6 shadow-2xl">
                    {/* Simulated Site Header */}
                    <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                      <div className="flex items-center gap-3">
                        <div className="flex size-9 items-center justify-center rounded-xl bg-gradient-to-tr from-cyan-500 to-blue-600 text-sm font-black text-slate-950">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          ...
                          className="flex items-center gap-1.5 rounded-xl bg-cyan-500 px-3.5 py-1.5 text-xs font-bold text-slate-950 shadow-[0_0_16px_rgba(0,210,255,0.4)] hover:bg-cyan-400 transition-all active:scale-95"
                        >
                    ...
                    {demoSitePage === 'home' && (
                      <div className="mt-6 space-y-6">
                        {/* Hero Section */}
                        <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-slate-900 via-[#0a1120] to-slate-900 p-6 border border-slate-800/80">
                          <div className="max-w-md space-y-2">
                            <span className="rounded-full bg-cyan-500/20 px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-cyan-300">
                            ...
                            <div className="flex items-center gap-3 pt-2">
                              <button
                                type="button"
                                onClick={() => setIsSimulatingCall(true)}
                                className="flex items-center gap-2 rounded-xl bg-white px-4 py-2 text-xs font-bold text-slate-950 hover:bg-slate-200 transition-colors shadow-md"
                              >
                              ...
                              <button
                                type="button"
                                onClick={() => setDemoSitePage('booking')}
                                className="rounded-xl border border-slate-700 bg-slate-800/50 px-4 py-2 text-xs font-semibold text-slate-200 hover:bg-slate-800 transition-colors"
                              >
                                Book Online
                              </button>
                            </div>
                          ...
                          <div className="absolute top-6 right-6 hidden md:block rounded-xl border border-slate-700/60 bg-[#0e1628]/90 p-4 shadow-xl text-right backdrop-blur-md">
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            {[
                              ...
                              <div
                                key={i}
                                className="group relative rounded-xl border border-slate-800 bg-[#0c121e] p-4 transition-all hover:border-cyan-500/40"
                              >
                                <span className="rounded bg-slate-800 px-1.5 py-0.5 text-[9px] font-semibold text-slate-300">
                                  {service.tag}
                                </span>
                                <h5 className="mt-2 text-xs font-bold text-white group-hover:text-cyan-300 transition-colors">
                                  {service.name}
                                </h5>
                    ...
                    {demoSitePage === 'booking' && (
                      <div className="mt-4 rounded-xl border border-slate-800 bg-[#090f1b] p-5 space-y-4">
                        <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                          <h4 className="font-display text-sm font-bold text-white">
                            Calendar Slot Locking System
                          </h4>
                          <span className="text-[11px] font-mono text-cyan-400">Two-Way Cal.com Sync</span>
                        </div>
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
                          {['09:00 AM', '11:30 AM', '02:00 PM', '04:15 PM'].map((slot, i) => (
                            <button
                              ...
                              className="rounded-xl border border-cyan-500/30 bg-cyan-500/10 p-3 text-center hover:bg-cyan-500/20 transition-all"
                            >
                              <div className="font-bold text-white">{slot}</div>
                              <div className="text-[10px] text-cyan-300 mt-1">Available Instant Lock</div>
                            </button>
                          ))}
                        </div>
                      </div>
                      ...
                      <div className="mt-4 rounded-xl border border-slate-800 bg-[#090f1b] p-5 space-y-4">
                        ...
                        <div className="space-y-2 text-xs">
                          <div className="flex items-center justify-between rounded-lg bg-slate-900/60 p-3">
                            <div>
                              <div className="font-semibold text-white">Fahad Al-Mansoor</div>
                              <div className="text-[10px] text-slate-400">Dental Implant Pre-Op Evaluation</div>
                            </div>
                    ...
                    {demoSitePage === 'whatsapp' && (
                      <div className="mt-4 mx-auto max-w-md rounded-2xl border border-emerald-500/40 bg-[#0b1b15] p-5 shadow-2xl space-y-3">
                        <div className="flex items-center justify-between border-b border-emerald-500/20 pb-2.5">
                          <div className="flex items-center gap-2">
                            <div className="flex size-7 items-center justify-center rounded-full bg-emerald-500 text-slate-950 font-bold text-xs">
                              W
                            </div>
                            <span className="font-bold text-white text-xs">{brandName} VIP Reception</span>
                          </div>
                          <span className="text-[10px] font-mono text-emerald-400">✓✓ Sent via Meta v21.0</span>
                        </div>
                        <div className="rounded-xl bg-[#082218] p-3.5 text-xs text-slate-200 space-y-2">
                          ...
                          <div className="flex flex-wrap items-center gap-2 pt-1">
                            ...
                            <span className="inline-flex items-center gap-1 rounded bg-cyan-500/20 px-2 py-0.5 text-[10px] font-semibold text-cyan-300">
                    ...
                    <AnimatePresence>
                      {isSimulatingCall && (
                        <motion.div
                          ...
                          className="absolute bottom-4 right-4 z-30 w-80 rounded-2xl border border-cyan-500/50 bg-[#091220]/95 p-4 shadow-[0_16px_40px_rgba(0,0,0,0.8)] backdrop-blur-xl"
                        >
                          <div className="flex items-center justify-between border-b border-slate-800 pb-2.5">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-xs font-bold text-white">Live Inbound Call</span>
                            </div>
                          ...
                          <div className="mt-3 flex items-center justify-between">
                            <span className="text-[10px] font-mono text-slate-400">Latency: 38ms LPU</span>
                            <button
                              type="button"
                              onClick={() => {
                    ...
                    {modules.map((mod) => (
                      <div
                        ...
                        className={cn(
                          ...
                          mod.enabled
                            ? 'border-cyan-500/40 bg-[#0c1628] shadow-[0_0_20px_rgba(0,210,255,0.08)]'
                            : 'border-slate-800 bg-[#090d16] opacity-60'
                        )}
                      >
                        <div className="space-y-2">
                          <div className="flex items-center justify-between">
                            <span className="rounded-md bg-slate-800 px-2 py-0.5 text-[10px] font-mono font-semibold text-slate-300 uppercase">
                              {mod.category}
                            </span>
                          ...
                          <h4 className="font-display text-sm font-bold text-white">{mod.name}</h4>
                        ...
                        <div className="mt-4 flex items-center justify-between border-t border-slate-800/80 pt-3">
                          ...
                          <button
                            ...
                            className={cn(
                              ...
                              mod.enabled
                                ? 'bg-cyan-500 text-slate-950 shadow-[0_0_12px_rgba(0,210,255,0.3)]'
              ...
              {activeIdeTab === 'workbench' && (
                <div className="space-y-5">
                  ...
                  <div className="rounded-xl border border-slate-800 bg-[#090d15] p-3 text-xs font-mono text-slate-300">
                  ...
                  <div className="rounded-2xl border border-slate-800 bg-[#090e18] p-5 space-y-4">
                    <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                      <div className="flex items-center gap-2">
                      ...
                      <span className="text-[11px] font-mono text-slate-500">Execution time: 1.4s</span>
                    </div>
            ...
            <div className="border-t border-slate-800/80 bg-[#090d15] p-3">
              <form onSubmit={handleSendPrompt} className="relative flex items-center gap-2 rounded-xl border border-slate-800 bg-[#0c121e] px-3 py-2 focus-within:border-cyan-500/50">
                <button
                  type="button"
                ...
                <div className="flex items-center gap-2">
                  <div className="hidden sm:flex items-center gap-1 rounded bg-slate-800/80 px-2 py-0.5 text-[10px] font-mono text-slate-400">
                  ...
                  <button
                    type="submit"
                    className="flex size-7 items-center justify-center rounded-lg bg-cyan-500 text-slate-950 shadow-[0_0_10px_rgba(0,210,255,0.3)] hover:bg-cyan-400 transition-colors"
                  >
          ...
          {/* ========================================================================= */}
          <aside className="flex flex-col border-l border-slate-800/80 bg-[#090d15] p-4 space-y-5">
            {/* Git Tools Panel (Image 1 Right Top) */}
            <div className="rounded-2xl border border-slate-800 bg-[#0c121e] p-4 space-y-3">
              <div className="flex items-center justify-between text-xs">
                <span className="font-mono text-slate-400 uppercase font-semibold">Git tools</span>
                <span className="font-mono text-xs font-bold text-emerald-400">+734 <span className="text-rose-400">-7</span></span>
              </div>

              <div className="flex items-center gap-2 rounded-xl border border-slate-800 bg-[#090d15] px-3 py-2 text-xs">
                <GitBranch className="size-3.5 text-cyan-400" />
                <span className="font-mono text-slate-300 truncate">feat/inbound-voice-mesh</span>
              </div>

              <button
                type="button"
                onClick={handleRequestBuild}
                className="w-full flex items-center justify-center gap-1.5 rounded-xl bg-slate-800 px-3 py-2 text-xs font-semibold text-white hover:bg-slate-700 transition-colors"
              >
            ...
            <div className="rounded-2xl border border-slate-800 bg-[#0c121e] p-4 space-y-2">
              <div className="flex items-center justify-between text-xs">
                <span className="font-mono text-slate-400 uppercase font-semibold">Active Goal</span>
              ...
              <div className="flex items-center gap-3 text-[10px] font-mono text-slate-400 pt-1 border-t border-slate-800/80">
                ...
                <span>•</span>
                <span className="text-cyan-400">89K tokens</span>
              </div>
            </div>
            ...
            <div className="flex-1 space-y-3">
              ...
              <div className="space-y-2 text-xs">
                {[
                  ...
                  { label: 'Wire SHA-256 cryptographic audit ledger', done: true },
                  { label: 'Connect Cal.com two-way calendar locking', done: true },
                  { label: 'Dispatch automated WhatsApp itinerary pin', done: true },
                ].map((item, index) => (
                  <div
                    key={index}
                    className="flex items-start gap-2.5 rounded-xl border border-slate-800/80 bg-[#090d16] p-2.5"
                  >
            ...
            <div className="rounded-xl border border-slate-800/80 bg-[#080c14] p-3 text-[11px] font-mono space-y-1.5">
              ...
              <div className="flex justify-between text-slate-400">
                ...
                <span className="text-cyan-400">340ms E2E</span>
              </div>
              <div className="flex justify-between text-slate-400">
      ...
      {modalResult && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 p-4 backdrop-blur-md animate-in fade-in">
          <div className="w-full max-w-md rounded-2xl border border-cyan-500/40 bg-[#0e1628] p-6 shadow-2xl">
            <div className="flex items-center justify-between">
