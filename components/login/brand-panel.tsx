  ...
  return (
    <aside className="relative flex h-[224px] flex-col justify-between overflow-hidden bg-deep text-deep-foreground lg:h-full lg:min-h-svh">
      <div className="relative flex items-center gap-3 p-6 lg:p-12">
        <HelixMark size={40} rounded="rounded-lg" />
        <div className="flex flex-col">
          <span className="font-display text-h3 leading-none tracking-tight text-deep-foreground">Helix AI</span>
          <span className="text-small text-deep-muted mt-1">Operations console</span>
        </div>
      </div>

      <div className="relative hidden px-12 lg:block">
        <h1 className="font-display text-h1 text-balance font-semibold leading-[1.05] tracking-tight text-deep-foreground">
